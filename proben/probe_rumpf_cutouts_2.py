...
fuselage_shape=OExs.translate_shp(fuselage_shape,Ogp.gp_Vec(0,0, 2))
...
hardware_box_height=fuselage_height*0.4+(rib_width/2)
...
fuselage_done=OAlgo.BRepAlgoAPI_Fuse(fuselage_hollow,rippen_gesamt).Shape()
