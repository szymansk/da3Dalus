...
class spar {
    ...
    spar_origin: Vector
    spar_mode: sparMode
    spar_position_factor: float
    spar_support_dimension_height: float
    spar_support_dimension_width: float
    spar_start: float
    spar_length: float
}
