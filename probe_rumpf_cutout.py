...
moved_hardware_box= OExs.translate_shp(hardware_box,Ogp.gp_Vec(0,-hardware_box_widht/2, -hardware_box_height/2))
...
#named_fuselage= TGeo.CNamedShape(fuselage_shape, "Hardware_CutOut")
