...
if __name__ == "__main__":
    ...
    full_fuselage_loft_node = ConstructionStepNode(
        StepImportCreator("full_fuselage",
                          step_file="./workspace/components/aircraft/RV-7/fuselage.step",
                          scale_x=base_scale,
    ...
    offset_fuselage_node = ConstructionStepNode(
        StepImportCreator("offset_fuselage",
                          step_file="./workspace/components/aircraft/RV-7/fuselage_inlets.step",
                          scale=base_scale))
    root_node.append(offset_fuselage_node)

    cockpit_node = ConstructionStepNode(
        StepImportCreator("cockpit",
                          step_file="./workspace/components/aircraft/RV-7/cockpit.step",
                          scale=base_scale))
    ...
    elevator_servo_shape_import = ConstructionStepNode(
        ServoImporterCreator("elevator_servo",
                             servo_feature="./workspace/components/servos/unknown/servo_24x24x12_inside.step",
                             servo_stamp="./workspace/components/servos/unknown/servo_24x24x12_inside_stamp.step",
                             servo_filling=None,
                             servo_model="./workspace/components/servos/AS215BBMG_left.step",
                             servo_idx=1))
    ...
    rudder_servo_shape_import = ConstructionStepNode(
        ServoImporterCreator("rudder_servo",
                             ...
                             servo_stamp="./workspace/components/servos/unknown/servo_24x24x12_inside_stamp.step",
                             servo_filling=None,
                             servo_model="./workspace/components/servos/AS215BBMG.step",
                             servo_idx=2))
    ...
    fuselage_reinforcement_node = ConstructionStepNode(
        FuselageReinforcementShapeCreator("fuselage_reinforcement_0", rib_width=0.0008, rib_spacing=0.00,  # 3,
                                          ribcage_factor=ribcage_factor, reinforcement_pipes_diameter=0.002,
    ...
    wing_support_node = ConstructionStepNode(
        FuselageWingSupportShapeCreator("wing_support", rib_quantity=18, rib_width=0.0008, rib_height_factor=1.0,
                                        fuselage_loft="engine_cape.loft", full_wing_loft="full_wing_loft",
    ...
    brushless_shape_import = ConstructionStepNode(
        ComponentImporterCreator("brushless",
                                 component_file="./workspace/components/brushless/DPower_AL3542-5_AL3542-7_AL35-09_v2.iges",
    ...
    lipo_model_import = ConstructionStepNode(
        ComponentImporterCreator("lipo_model",
                                 component_file="./workspace/components/lipo/D-Power HD-2200 4S Lipo (14,8V) 30C v1.iges",
                                 component_idx="lipo",
                                 loglevel=logging.DEBUG
                                 ))
    ...
    json_file_path = f"/home/cadquery/workspace/components/constructions/{root_node.identifier}.json"
