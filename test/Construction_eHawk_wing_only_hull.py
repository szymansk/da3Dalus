...
if __name__ == "__main__":
    ...
    aircraft_step_export_node = ConstructionStepNode(
        ExportToStlCreator(Path(f"{root_node.identifier}").stem,
                            file_path="../exports",
    ...
    wing_config.add_segment(length=200, sweep=2.5,
                            tip_airfoil=Airfoil(chord=157, dihedral_as_rotation_in_degrees=0, incidence=0),
                            spare_list=[
                                Spare(spare_support_dimension_width=4.42,
                                      spare_support_dimension_height=4.42,
                                      spare_mode="follow"),
    ...
    wing_config.add_segment(
        length=l_middle,
        sweep=s_middle,
        tip_airfoil=Airfoil(chord=c_middle, dihedral_as_rotation_in_degrees=0, incidence=0),
        spare_list=[
            Spare(spare_support_dimension_width=4.42,
                  spare_support_dimension_height=4.42,
                  spare_mode="follow")],
    ...
    wing_config.add_segment(
        length=l_tip,
        sweep=s_tip,
        tip_airfoil=Airfoil(chord=c_tip, dihedral_as_rotation_in_degrees=0, incidence=0),
        spare_list=[
            Spare(spare_support_dimension_width=4.42,
                  spare_support_dimension_height=4.42,
                  spare_mode="follow")],
    ...
    wing_config.add_tip_segment(
        length=5,
        sweep=17.5,
        tip_airfoil=Airfoil(chord=90-2*7.5-10-12.5-15-17.5+4, dihedral_as_rotation_in_degrees=0, incidence=-0.5),
        tip_type='flat'
    )
