...
DEFAULT_SEED_TYPES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "label": "ESC",
        "description": None,
        # gh-1009: canonical English-label schema with boolean BEC voltage toggles,
        # NiXX/Li-Ion cell ranges, and removed legacy fields (cells, bec_voltage_v,
        # bec_output). The matching Alembic migration rewrites the DB row and
        # data-migrates existing component specs.
        "schema": [
            {
            ...
            {
                "name": "cells_liion_min",
                "label": "Li-Ion/LiHV Cells Min",
                "type": "number",
                "unit": "S",
            },
            {
                "name": "cells_liion_max",
                "label": "Li-Ion/LiHV Cells Max",
                "type": "number",
                "unit": "S",
            },
