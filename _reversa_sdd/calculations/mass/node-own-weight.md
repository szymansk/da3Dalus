...
**Inputs.** [[weight-override-g|Manual node weight override]] · [[cots-node-own-weight|COTS node own weight]] · [[cad-shape-own-weight-surface|CAD shape own weight — surface print]] · [[cad-shape-own-weight-volume|CAD shape own weight — solid print]]

**Produced by.** `app/services/component_tree_service.py:461` — `_calculate_own_weight`

**Consumed by.**

- in this graph: [[aircraft-total-weight-kg|Aircraft total weight from component tree]] · [[node-children-weight|Node children weight (recursive)]] · [[node-own-weight-source|Own weight provenance]] · [[node-total-weight-api|Node total weight (single-node endpoint)]] · [[node-total-weight-rollup|Node total weight (tree roll-up)]]
