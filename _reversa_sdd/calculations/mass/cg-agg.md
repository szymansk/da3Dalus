...
**Inputs.** [[scenario-cg-x|Loading-scenario CG_x]] · [[base-mass-default|Fallback base mass for scenario CG]] · [[base-cg-x-default|Fallback base CG_x for scenario CG]]

**Produced by.** `app/services/loading_scenario_service.py:345` — `compute_cg_agg_for_aeroplane`

**Consumed by.**

- in this graph: [[cg-agg-m-ctx|Published aggregate CG (computation context)]]
