...
- [[inch-to-metre|Inch-to-metre conversion factor]]  — *× unit*
...
- in this graph: `Advance ratio per velocity sample` · `Shaft power per velocity sample` · `Thrust per velocity sample`  
