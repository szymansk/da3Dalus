...
**Inputs.** [[tos-cd-values|cd sweep over the trip grid]] · [[tos-xtr-grid|Turbulator trip-position sweep grid]]

**Produced by.** `app/services/turbulator_optimizer_service.py:257` — `optimize_section_xtr`

**Consumed by.**

- in this graph: [[tos-boundary-warning|Grid-boundary minimum warning]] · [[tos-cd-tripped|Tripped section drag]]
