...
- in this graph: [[half-span-mm|Wing half-span]] · [[host-root-y|Host segment root spanwise position]] · [[per-segment-y-global|Global span fraction per segment station]] · [[segment-for-y|Spanwise position to segment index]] · [[subsegment-lengths-m|Post-split sub-segment lengths]] · [[y-span-to-segment|Span fraction to segment mapping]]
