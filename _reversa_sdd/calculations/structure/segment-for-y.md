...
**Inputs.** [[segment-lengths|Per-segment spanwise lengths]] · [[station-y-mm|Station spanwise position]]

**Produced by.** `app/services/spar_insert_service.py:108` — `_segment_for_y`

**Consumed by.**

- in this graph: [[host-root-y|Host segment root spanwise position]]
