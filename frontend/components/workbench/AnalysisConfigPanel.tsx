  ...
  return (
    <div className="flex w-[556px] shrink-0 flex-col gap-4 overflow-y-auto">
      ...
      <div className="flex items-center gap-2">
        <button className="flex items-center gap-2 rounded-[--radius-pill] bg-primary px-4 py-2.5 font-[family-name:var(--font-geist-sans)] text-[13px] text-primary-foreground transition-colors hover:opacity-90">
          <Play size={14} />
          Run Analysis
        </button>
        <button className="flex items-center gap-1.5 rounded-[--radius-pill] border border-border bg-card-muted px-3.5 py-2.5 font-[family-name:var(--font-geist-sans)] text-[13px] text-foreground transition-colors hover:bg-sidebar-accent">
          <RefreshCw size={14} />
          Clear Results
        </button>
        ...
        <button className="px-3 py-2 font-[family-name:var(--font-geist-sans)] text-[12px] text-muted-foreground transition-colors hover:text-foreground">
          Reset to defaults
        </button>
      </div>
      ...
      <div className="flex flex-col gap-3 rounded-[--radius-m] border border-border bg-card p-4">
        ...
        <div className="relative">
          <select className="w-full appearance-none rounded-[--radius-s] border border-border bg-input px-3 py-2 pr-8 font-[family-name:var(--font-geist-sans)] text-[13px] text-foreground">
            <option>aerobuildup</option>
            <option>avl</option>
            <option>vortex_lattice</option>
          </select>
          <ChevronDown
            size={14}
            className="pointer-events-none absolute right-2.5 top-1/2 -translate-y-1/2 text-muted-foreground"
