...
class ShellCreator:
    ...
    def create_shell(self, thickness, achs="Y", end="min"):
        ...
        a_face_explorer = TopExp_Explorer(self.named_shape.fuselage(), TopAbs_FACE)
        ...
        make_thick_solid = BRepOffsetAPI_MakeThickSolid(self.named_shape.fuselage(), faces_to_remove, thickness, 0.0001)
